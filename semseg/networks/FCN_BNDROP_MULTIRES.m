function [net, info] = FCN_BNDROP_MULTIRES(imdb, netF, inpt, varargin)
...
% defining batch policies 
	...
	net.addLayer('bn1_1_r1', dagnn.BatchNorm('numChannels', 64), {'conv1_1_r1'}, {'conv1_1b_r1'}, {'bn1_1f', 'bn1_1b', 'bn1_1m'});
	net.addLayer('dropout1_1_r1', dagnn.DropOut('rate', 0.1), {'conv1_1b_r1'}, {'conv1_1d_r1'}, {});	
	net.addLayer('relu1_1_r1', dagnn.ReLU(), {'conv1_1d_r1'}, {'conv1_1x_r1'}, {});
	...
	net.addLayer('bn1_2_r1', dagnn.BatchNorm('numChannels', 64), {'conv1_2_r1'}, {'conv1_2b_r1'}, {'bn1_2f', 'bn1_2b', 'bn1_2m'});
	net.addLayer('dropout1_2_r1', dagnn.DropOut('rate', 0.1), {'conv1_2b_r1'}, {'conv1_2d_r1'}, {});		
	net.addLayer('relu1_2_r1', dagnn.ReLU(), {'conv1_2d_r1'}, {'conv1_2x_r1'}, {});
	...
	net.addLayer('bn1_1_r2', dagnn.BatchNorm('numChannels', 64), {'conv1_1_r2'}, {'conv1_1b_r2'}, {'bn1_1f', 'bn1_1b', 'bn1_1m'});
	net.addLayer('dropout1_1_r2', dagnn.DropOut('rate', 0.1), {'conv1_1b_r2'}, {'conv1_1d_r2'}, {});	
	net.addLayer('relu1_1_r2', dagnn.ReLU(), {'conv1_1d_r2'}, {'conv1_1x_r2'}, {});
	...
	net.addLayer('bn1_2_r2', dagnn.BatchNorm('numChannels', 64), {'conv1_2_r2'}, {'conv1_2b_r2'}, {'bn1_2f', 'bn1_2b', 'bn1_2m'});
	net.addLayer('dropout1_2_r2', dagnn.DropOut('rate', 0.1), {'conv1_2b_r2'}, {'conv1_2d_r2'}, {});		
	net.addLayer('relu1_2_r2', dagnn.ReLU(), {'conv1_2d_r2'}, {'conv1_2x_r2'}, {});
	...
	net.addLayer('bn2_1_r1', dagnn.BatchNorm('numChannels', 128), {'conv2_1_r1'}, {'conv2_1b_r1'}, {'bn2_1f', 'bn2_1b', 'bn2_1m'});
	net.addLayer('dropout2_1_r1', dagnn.DropOut('rate', 0.1), {'conv2_1b_r1'}, {'conv2_1d_r1'}, {});		
	net.addLayer('relu2_1_r1', dagnn.ReLU(), {'conv2_1d_r1'}, {'conv2_1x_r1'}, {});
	...
	net.addLayer('bn2_2_r1', dagnn.BatchNorm('numChannels', 128), {'conv2_2_r1'}, {'conv2_2b_r1'}, {'bn2_2f', 'bn2_2b', 'bn2_2m'});	
	net.addLayer('dropout2_2_r1', dagnn.DropOut('rate', 0.1), {'conv2_2b_r1'}, {'conv2_2d_r1'}, {});		
	net.addLayer('relu2_2_r1', dagnn.ReLU(), {'conv2_2d_r1'}, {'conv2_2x_r1'}, {});
	...
	net.addLayer('bn2_1_r2', dagnn.BatchNorm('numChannels', 128), {'conv2_1_r2'}, {'conv2_1b_r2'}, {'bn2_1f', 'bn2_1b', 'bn2_1m'});
	net.addLayer('dropout2_1_r2', dagnn.DropOut('rate', 0.1), {'conv2_1b_r2'}, {'conv2_1d_r2'}, {});		
	net.addLayer('relu2_1_r2', dagnn.ReLU(), {'conv2_1d_r2'}, {'conv2_1x_r2'}, {});
	...
	net.addLayer('bn2_2_r2', dagnn.BatchNorm('numChannels', 128), {'conv2_2_r2'}, {'conv2_2b_r2'}, {'bn2_2f', 'bn2_2b', 'bn2_2m'});	
	net.addLayer('dropout2_2_r2', dagnn.DropOut('rate', 0.1), {'conv2_2b_r2'}, {'conv2_2d_r2'}, {});		
	net.addLayer('relu2_2_r2', dagnn.ReLU(), {'conv2_2d_r2'}, {'conv2_2x_r2'}, {});
	...
	net.addLayer('bn3_1_r1', dagnn.BatchNorm('numChannels', 256), {'conv3_1_r1'}, {'conv3_1b_r1'}, {'bn3_1f', 'bn3_1b', 'bn3_1m'});	
	net.addLayer('dropout3_1_r1', dagnn.DropOut('rate', 0.1), {'conv3_1b_r1'}, {'conv3_1d_r1'}, {});		
	net.addLayer('relu3_1_r1', dagnn.ReLU(), {'conv3_1d_r1'}, {'conv3_1x_r1'}, {});
	...
	net.addLayer('bn3_2_r1', dagnn.BatchNorm('numChannels', 256), {'conv3_2_r1'}, {'conv3_2b_r1'}, {'bn3_2f', 'bn3_2b', 'bn3_2m'});	
	net.addLayer('dropout3_2_r1', dagnn.DropOut('rate', 0.1), {'conv3_2b_r1'}, {'conv3_2d_r1'}, {});		
	net.addLayer('relu3_2_r1', dagnn.ReLU(), {'conv3_2d_r1'}, {'conv3_2x_r1'}, {});
	...
	net.addLayer('bn3_3_r1', dagnn.BatchNorm('numChannels', 256), {'conv3_3_r1'}, {'conv3_3b_r1'}, {'bn3_3f', 'bn3_3b', 'bn3_3m'});	
	net.addLayer('dropout3_3_r1', dagnn.DropOut('rate', 0.1), {'conv3_3b_r1'}, {'conv3_3d_r1'}, {});		
	net.addLayer('relu3_3_r1', dagnn.ReLU(), {'conv3_3d_r1'}, {'conv3_3x_r1'}, {});
	...
	net.addLayer('bn3_1_r2', dagnn.BatchNorm('numChannels', 256), {'conv3_1_r2'}, {'conv3_1b_r2'}, {'bn3_1f', 'bn3_1b', 'bn3_1m'});	
	net.addLayer('dropout3_1_r2', dagnn.DropOut('rate', 0.1), {'conv3_1b_r2'}, {'conv3_1d_r2'}, {});		
	net.addLayer('relu3_1_r2', dagnn.ReLU(), {'conv3_1d_r2'}, {'conv3_1x_r2'}, {});
	...
	net.addLayer('bn3_2_r2', dagnn.BatchNorm('numChannels', 256), {'conv3_2_r2'}, {'conv3_2b_r2'}, {'bn3_2f', 'bn3_2b', 'bn3_2m'});	
	net.addLayer('dropout3_2_r2', dagnn.DropOut('rate', 0.1), {'conv3_2b_r2'}, {'conv3_2d_r2'}, {});		
	net.addLayer('relu3_2_r2', dagnn.ReLU(), {'conv3_2d_r2'}, {'conv3_2x_r2'}, {});
	...
	net.addLayer('bn3_3_r2', dagnn.BatchNorm('numChannels', 256), {'conv3_3_r2'}, {'conv3_3b_r2'}, {'bn3_3f', 'bn3_3b', 'bn3_3m'});	
	net.addLayer('dropout3_3_r2', dagnn.DropOut('rate', 0.1), {'conv3_3b_r2'}, {'conv3_3d_r2'}, {});		
	net.addLayer('relu3_3_r2', dagnn.ReLU(), {'conv3_3d_r2'}, {'conv3_3x_r2'}, {});
	...
	net.addLayer('bn4_1_r1', dagnn.BatchNorm('numChannels', 512), {'conv4_1_r1'}, {'conv4_1b_r1'}, {'bn4_1f', 'bn4_1b', 'bn4_1m'});
	net.addLayer('dropout4_1_r1', dagnn.DropOut('rate', 0.1), {'conv4_1b_r1'}, {'conv4_1d_r1'}, {});		
	net.addLayer('relu4_1_r1', dagnn.ReLU(), {'conv4_1d_r1'}, {'conv4_1x_r1'}, {});
	...
	net.addLayer('bn4_2_r1', dagnn.BatchNorm('numChannels', 512), {'conv4_2_r1'}, {'conv4_2b_r1'}, {'bn4_2f', 'bn4_2b', 'bn4_2m'});
	net.addLayer('dropout4_2_r1', dagnn.DropOut('rate', 0.1), {'conv4_2b_r1'}, {'conv4_2d_r1'}, {});		
	net.addLayer('relu4_2_r1', dagnn.ReLU(), {'conv4_2d_r1'}, {'conv4_2x_r1'}, {});
	...
	net.addLayer('bn4_3_r1', dagnn.BatchNorm('numChannels', 512), {'conv4_3_r1'}, {'conv4_3b_r1'}, {'bn4_3f', 'bn4_3b', 'bn4_3m'});	
	net.addLayer('dropout4_3_r1', dagnn.DropOut('rate', 0.1), {'conv4_3b_r1'}, {'conv4_3d_r1'}, {});	
	net.addLayer('relu4_3_r1', dagnn.ReLU(), {'conv4_3d_r1'}, {'conv4_3x_r1'}, {});
	...
	net.addLayer('bn4_1_r2', dagnn.BatchNorm('numChannels', 512), {'conv4_1_r2'}, {'conv4_1b_r2'}, {'bn4_1f', 'bn4_1b', 'bn4_1m'});
	net.addLayer('dropout4_1_r2', dagnn.DropOut('rate', 0.1), {'conv4_1b_r2'}, {'conv4_1d_r2'}, {});		
	net.addLayer('relu4_1_r2', dagnn.ReLU(), {'conv4_1d_r2'}, {'conv4_1x_r2'}, {});
	...
	net.addLayer('bn4_2_r2', dagnn.BatchNorm('numChannels', 512), {'conv4_2_r2'}, {'conv4_2b_r2'}, {'bn4_2f', 'bn4_2b', 'bn4_2m'});
	net.addLayer('dropout4_2_r2', dagnn.DropOut('rate', 0.1), {'conv4_2b_r2'}, {'conv4_2d_r2'}, {});		
	net.addLayer('relu4_2_r2', dagnn.ReLU(), {'conv4_2d_r2'}, {'conv4_2x_r2'}, {});
	...
	net.addLayer('bn4_3_r2', dagnn.BatchNorm('numChannels', 512), {'conv4_3_r2'}, {'conv4_3b_r2'}, {'bn4_3f', 'bn4_3b', 'bn4_3m'});	
	net.addLayer('dropout4_3_r2', dagnn.DropOut('rate', 0.1), {'conv4_3b_r2'}, {'conv4_3d_r2'}, {});	
	net.addLayer('relu4_3_r2', dagnn.ReLU(), {'conv4_3d_r2'}, {'conv4_3x_r2'}, {});
	...
	net.addLayer('bn5_1_r1', dagnn.BatchNorm('numChannels', 512), {'conv5_1_r1'}, {'conv5_1b_r1'}, {'bn5_1f', 'bn5_1b', 'bn5_1m'});	
	net.addLayer('dropout5_1_r1', dagnn.DropOut('rate', 0.1), {'conv5_1b_r1'}, {'conv5_1d_r1'}, {});		
	net.addLayer('relu5_1_r1', dagnn.ReLU(), {'conv5_1d_r1'}, {'conv5_1x_r1'}, {});
	...
	net.addLayer('bn5_2_r1', dagnn.BatchNorm('numChannels', 512), {'conv5_2_r1'}, {'conv5_2b_r1'}, {'bn5_2f', 'bn5_2b', 'bn5_2m'});	
	net.addLayer('dropout5_2_r1', dagnn.DropOut('rate', 0.1), {'conv5_2b_r1'}, {'conv5_2d_r1'}, {});	
	net.addLayer('relu5_2_r1', dagnn.ReLU(), {'conv5_2d_r1'}, {'conv5_2x_r1'}, {});
	...
	net.addLayer('bn5_3_r1', dagnn.BatchNorm('numChannels', 512), {'conv5_3_r1'}, {'conv5_3b_r1'}, {'bn5_3f', 'bn5_3b', 'bn5_3m'});	
	net.addLayer('dropout5_3_r1', dagnn.DropOut('rate', 0.1), {'conv5_3b_r1'}, {'conv5_3d_r1'}, {});	
	net.addLayer('relu5_3_r1', dagnn.ReLU(), {'conv5_3d_r1'}, {'conv5_3x_r1'}, {});
	...
	net.addLayer('bn5_1_r2', dagnn.BatchNorm('numChannels', 512), {'conv5_1_r2'}, {'conv5_1b_r2'}, {'bn5_1f', 'bn5_1b', 'bn5_1m'});	
	net.addLayer('dropout5_1_r2', dagnn.DropOut('rate', 0.1), {'conv5_1b_r2'}, {'conv5_1d_r2'}, {});		
	net.addLayer('relu5_1_r2', dagnn.ReLU(), {'conv5_1d_r2'}, {'conv5_1x_r2'}, {});
	...
	net.addLayer('bn5_2_r2', dagnn.BatchNorm('numChannels', 512), {'conv5_2_r2'}, {'conv5_2b_r2'}, {'bn5_2f', 'bn5_2b', 'bn5_2m'});	
	net.addLayer('dropout5_2_r2', dagnn.DropOut('rate', 0.1), {'conv5_2b_r2'}, {'conv5_2d_r2'}, {});	
	net.addLayer('relu5_2_r2', dagnn.ReLU(), {'conv5_2d_r2'}, {'conv5_2x_r2'}, {});
	...
	net.addLayer('bn5_3_r2', dagnn.BatchNorm('numChannels', 512), {'conv5_3_r2'}, {'conv5_3b_r2'}, {'bn5_3f', 'bn5_3b', 'bn5_3m'});	
	net.addLayer('dropout5_3_r2', dagnn.DropOut('rate', 0.1), {'conv5_3b_r2'}, {'conv5_3d_r2'}, {});	
	net.addLayer('relu5_3_r2', dagnn.ReLU(), {'conv5_3d_r2'}, {'conv5_3x_r2'}, {});
	...
	net.addLayer('concat', dagnn.Concat('dim', 3), {'bigscore_r1', 'relu_upr2x2'}, {'concat'});
	net.addLayer('classifier', dagnn.Conv('size', [5 5 2*CLASSES CLASSES], 'hasBias', true, 'stride', [1, 1], 'pad', [2 2 2 2]), {'concat'}, {'classifier'},  {'classf'  'classb'});
