function Y = vl_nnsoftmaxlossWeights(X,c, W, classMap, dzdy)
...
% index from 0
% This line has been commented out for the special case of
% considering class 0! Take it out when you finished
%c = c - 1 ;
c = c(:,:,1,:);


if(~isempty(classMap))
	% modify c according to classMap
...
weights = reshape(W(c(:)' + 1), size(Xmax));
